...
import (
	...
	calc "github.com/lockwobr/goa-example-multi-type/pkg"
...
func main() {
	...
	var (
		exmpSvc exmp.Service
	)
	{
		exmpSvc = calc.NewExmp(logger)
	}

	// Wrap the services in endpoints that can be invoked from other services
	// potentially running in different processes.
	var (
		exmpEndpoints *exmp.Endpoints
	)
	{
		exmpEndpoints = exmp.NewEndpoints(exmpSvc)
	}
	...
	case "development":
		{
			...
			handleHTTPServer(ctx, u, exmpEndpoints, &wg, errc, logger, *dbgF)
		}
